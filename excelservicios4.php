...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <? $totalc= $totalc+$dc1; echo number_format($dc1,2); ?></strong>
 <?php } ?>
 </td>
 ...
 <?
 $d=0;
$query1 = "SELECT * FROM ingresosyegresos where id_mudanza=".$row[0]." and banco='INBURSA' and referencia=1";
...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <? $totalc= $totalc+$dc7; echo number_format($dc7,2); ?></strong>
 <?php
}
?>
 </td>
...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <? $totalc= $totalc+$dc2; echo number_format($dc2,2); ?></strong>
 <?php
}
?>
 </td>
...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <? $totalc= $totalc+$dc3; echo number_format($dc3,2); ?></strong>
 <?php
}
?>
 </td>
...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <? $totalc= $totalc+$dc5; echo number_format($dc5,2); ?></strong>
 <?php
}
?>
 </td>
...
if($d!=1){ ?><br><?php }
?>
 <strong>$ <?  $totalc= $totalc+$dc6; echo number_format($dc6,2); ?></strong>
 <?php
}
?>
 </td>
...
while($rowp1=mysqli_fetch_row($resultp1)){
 ...
 $d=0;
$queryp7 = "SELECT * FROM ingresosyegresos where id_mudanza=".$row[0]." and banco='INBURSA' and referencia=2";
$resultp7 = $link->query($queryp7);
...
$d++;
  if($d!=1){ ?><br><?php }
  ?>
   <strong>$ <? $totalp=$totalp+$dcp3; echo number_format($dcp3,2); ?></strong>
   <?php
  }
  ?>
   </td>
...
$d++;
  if($d!=1){ ?><br><?php }
  ?>
   <strong>$ <? $totalp=$totalp+$dcp5; echo number_format($dcp5,2); ?></strong>
   <?php
  }
  ?>
   </td>
