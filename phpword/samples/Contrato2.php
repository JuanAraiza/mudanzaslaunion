...
$no1 = new TextRun();
$dd=strtoupper($row[4]);
$no1->addText($dd, array('bold' => true, 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('tipo', $no1);

$no2 = new TextRun();
$dd=($row[4]);
$no2->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('tipo2', $no2);

$no3 = new TextRun();
$dd=($row[4]);
$no3->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('tipo3', $no3);


$no4 = new TextRun();
$dd=($row[1]);
$no4->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('nombre_c', $no4);

$no5 = new TextRun();
$dd=($row[104]);
$no5->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('sr', $no5);

$no6 = new TextRun();
$dd=($row[89]);
$no6->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ruta', $no6);

$no7 = new TextRun();
$dd=substr($row[22],8,2).' de '.mes(substr($row[22],5,2)).' del '.substr($row[22],0,4);
$no7->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('fecha_ini', $no7);

$no8 = new TextRun();
$dd=($row[2]);
$no8->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('origen', $no8);

$no9 = new TextRun();
$dd=($row[3]);
$no9->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('destino', $no9);

$no10 = new TextRun();
$dd=($row[106]);
$no10->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('estado_o', $no10);

$no11 = new TextRun();
$dd=($row[108]);
$no11->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no12 = new TextRun();
$dd=($row[24]);
$no12->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('calle_r', $no12);

$no13 = new TextRun();
$dd=($row[25]);
$no13->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('colonia_r', $no13);

$no14 = new TextRun();
$dd=($row[105]);
$no14->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('cp_r', $no14);

$no15 = new TextRun();
$dd=($row[44]);
$no15->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ciudad_r', $no15);

$no16 = new TextRun();
$dd=($row[106]);
$no16->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no17 = new TextRun();
$dd=($row[29]);
$no17->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('calle_e', $no17);

$no18 = new TextRun();
$dd=($row[30]);
$no18->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('colonia_e', $no18);

$no19 = new TextRun();
$dd=($row[107]);
$no19->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('cp_e', $no19);

$no20 = new TextRun();
$dd=($row[45]);
$no20->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ciudad_e', $no20);

$no21 = new TextRun();
$dd=($row[108]);
$no21->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no22 = new TextRun();
$dd=($row[4]);
$no22->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
//$no23->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no23->addText(array_shift($textlines), array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
foreach($textlines as $line) {
  $no23->addTextBreak();
    // maybe twice if you want to seperate the text
    // $textrun->addTextBreak(2);
    $no23->addText($line, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
}
$templateProcessor->setComplexValue('lista_m', $no23);

$no24 = new TextRun();
$dd=number_format($row[42],2);
$no24->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no25->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no26->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('suma_ase', $no26);

$no27 = new TextRun();
$dd=number_format($row[100],2);
$no27->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('costo_seguro', $no27);

$montoss=$row[82]+$row[100];
$no28 = new TextRun();
$dd=number_format($montoss,2);
$no28->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('sub_total', $no28);

$suma_seg=$row[42]+$montoss;

$no29 = new TextRun();
$dd=number_format($suma_seg,2);
$no29->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('suma_seguro', $no29);
...
$no30 = new TextRun();
$dd=strtoupper($formatterES->format($izquierda));
$no30->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('suma_seguro_l', $no30);
...
$no31->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('iva', $no31);

$suma_tot=$suma_seg+$iva;

$no32 = new TextRun();
$dd=number_format($suma_tot,2);
$no32->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('total_servicio', $no32);
...
$no33 = new TextRun();
$dd=strtoupper($formatterES->format($izquierda));
$no33->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('total_servicio_l', $no33);

$no34 = new TextRun();
$dd=number_format($row[19],2);
$no34->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('suma_seguro2', $no34);


$no35 = new TextRun();
$dd=$row[109];
$no35->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ine', $no35);
$no36 = new TextRun();
$dd=$row[110];
$no36->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('calle', $no36);
$no37 = new TextRun();
$dd=$row[111];
$no37->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('colonia', $no37);
$no38 = new TextRun();
$dd=$row[112];
$no38->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ciudad', $no38);
$no39 = new TextRun();
$dd=$row[113];
$no39->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('estado', $no39);
$no40 = new TextRun();
$dd=$row[114];
$no40->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('cp', $no40);
$no41 = new TextRun();
$dd=$row[50];
$no41->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('cel', $no41);
$no42 = new TextRun();
$dd=$row[49];
$no42->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('email', $no42);

$no43 = new TextRun();
$dd=$row[117];
$no43->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('fuente_i', $no43);


$no44 = new TextRun();
$dd=str_replace('<br />','',$row[117]);
$no44->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
if($row[61]!=''){
  ...
  $no45->addTextBreak();
    $no45->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
}
if($row[62]!=''){
...
$dd=strtoupper($dd);
$no46->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no47 = new TextRun();
  $dd=$rowp[1].' '.$rowp[2];
    $no47->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
    $templateProcessor->setComplexValue('proveedor', $no47);

    $no48 = new TextRun();
    $dd=$row[119];
    $no48->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
    $templateProcessor->setComplexValue('poliza_s', $no48);

    $no49 = new TextRun();
    $dd=$row[120];
    $no49->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
    $templateProcessor->setComplexValue('categoria_s', $no49);
    
    $no50 = new TextRun();
    $dd=str_replace('<br />','',$row[39]);
    $no50->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
    $templateProcessor->setComplexValue('condiciones_p', $no50);

      $no51 = new TextRun();
      $dd=number_format($ss,2);
      $no51->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
      $templateProcessor->setComplexValue('suma_asegurada', $no51);

      $no52 = new TextRun();
$dd=($row[1]);
$no52->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$no53 = new TextRun();
$dd=($rowpa[2]);
$no53->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('p_ant', $no53);

$no54 = new TextRun();
$dd=($rowpa[3]);
$no54->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('p_car', $no54);

$no55 = new TextRun();
$dd=($rowpa[4]);
$no55->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('p_des', $no55);

$no56 = new TextRun();
$dd=number_format($rowpa[5],2);
$no56->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('ant', $no56);

$no57 = new TextRun();
$dd=number_format($rowpa[6],2);
$no57->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
$templateProcessor->setComplexValue('car', $no57);

$no58 = new TextRun();
$dd=number_format($rowpa[7],2);
$no58->addText($dd, array( 'size' => 11, 'color' => '000000', 'name' => 'Lucida Sans Unicode'));
...
$templateProcessor->setImageValue('img_ine', array('path' => 'http://applaunionmudanzas.com/ine-ejemplo.jpg', 'width' => 100, 'height' => 100, 'ratio' => false));
...
echo "<a href='http://applaunionmudanzas.com/phpword/samples/results/Contrato_".$row[0].".docx' class='btn btn-primary' target='_blank'>Descargar Archivo</a>";
//echo getEndingNotes(array('Word2007' => 'docx'), 'results/Convocatoria_Sesion.docx');

}else{
  echo "<a href='Contrato2.php?dos=1&c=".$_GET['c']."' class='btn btn-primary' target='_self'>Generar Contrato</a>";
}
if (!CLI) {
