...
<div class="col-md-12 row">
        ...
        <div class="form-group  col-md-12" id="lista_muebles" >
                  ...
                  <textarea  id="muebles" name="muebles" class="form-control" rows="3" placeholder="marca modelo ..." style="text-transform: uppercase;" ><?php if($_GET['edi']==1){ echo str_replace('<br />','',$rowe[10]); }else{ echo $_POST['muebles']; } ?></textarea>
                </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <input name="costo_m3" id="costo_m3" placeholder="0.0" style="text-transform: uppercase;" class="form-control" onkeypress="return valida(event)" type="text" autocomplete="off" value="<?php if($_GET['edi']==1){ echo $rowe[12]; }else{  echo $_POST['costo_m3']; } ?>" >
              ...
              <div class="input-group">
              <div class="input-group-addon">Gruas</div>
            <input name="gruas" id="gruas" placeholder="0.0" style="text-transform: uppercase;" class="form-control" onkeypress="return valida(event)" type="text" autocomplete="off" value="<?php if($_GET['edi']==1){ echo $rowe[42]; }else{ echo $_POST['gruas']; } ?>" >
            </div>
            ...
            <input name="unidad" id="unidad" type="hidden"  value="<?php if($_GET['edi']==1){ echo $rowe[19]; }else{ echo $_POST['unidad']; } ?>" >
            <input name="kms" id="kms" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[20]; }else{ echo $_POST['kms']; } ?>" >
            <input name="combustible" id="combustible" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[21]; }else{ echo $_POST['combustible']; } ?>" >
            <input name="casetas" id="casetas" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[22]; }else{ echo $_POST['casetas']; } ?>" >
            <input name="d_unidad" id="d_unidad" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[23]; }else{ echo $_POST['d_unidad']; } ?>" >
            <input name="maniobras" id="maniobras" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[24]; }else{ echo $_POST['maniobras']; } ?>" >
            <input name="otro" id="otro" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[25]; }else{ echo $_POST['otro']; } ?>" >
        ...
        <div class="form-group">
              ...
              <input name="pisos" id="pisos" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[28]; }else{ echo $_POST['pisos']; } ?>" >
              <input name="empaque" id="empaque" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[29]; }else{ echo $_POST['empaque']; } ?>" >
            ...
            <input name="m32" id="m32" value="" type="hidden">
              ...
              <input name="permisos" id="permisos" type="hidden" value="<?php if($_GET['edi']==1){ echo $rowe[31]; }else{ echo $_POST['permisos']; } ?>" >
            ...
            <div class="input-group mb-12">
              ...
              <div class="input-group">
              <div class="input-group-addon">Total Cliente0</div>
