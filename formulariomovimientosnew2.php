...
<?php  if($_SESSION['tipo_usuario']!='visor'){ ?>
  ...
  <div class="form-group col-md-3" >
      ...
      <div class="form-group col-md-3" >
        ...
        <div class="form-group col-md-3">
           <label>Para</label>
           <select name="para"  class="form-control select2" onChange="ajusteProveedor" >
           <option value="--">--</option>
      ...
      <div class="form-group col-md-3">
           ...
           <select name="ajusproveedor"  class="form-control select2" >
           <?php
 // $queryp = "SELECT * from proveedores where id in (".$row[40].",".$row[88].",".$row[89].")";
 if($row[40]!=''){
  $pr1=$row[40];
 }else{
  $pr1=0;
 ...
 if($row[88]!=''){
  ...
  $queryp = "SELECT * from proveedores where id in (".$pr1.",".$pr2.",".$pr3.")";
