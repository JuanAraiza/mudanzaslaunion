...
<div class="col-md-12 row">
        ...
        <div class="form-group  col-md-12" id="lista_muebles" >
                  <label>Listado de Muebles</label>
                  <textarea  id="muebles" name="muebles" class="form-control" rows="20" placeholder="muebles ..." style="text-transform: uppercase;" ><?php if($_GET['edi']==1){ echo str_replace('<br />','',$rowe[10]); }else{ echo $_POST['muebles']; } ?></textarea>
        </div>
        </div>
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            ...
            <div class="input-group">
              <div class="input-group-addon">Embodegamiento</div>
              <input name="embodegamiento" id="embodegamiento" style="text-transform: uppercase;" class="form-control"  type="text" autocomplete="off" value="<?php if($_GET['edi']==1){ echo $rowe[31]; }else{ echo $_POST['embodegamiento']; } ?>" >
            </div>
